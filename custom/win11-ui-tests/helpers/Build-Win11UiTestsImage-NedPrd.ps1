...
Write-Host ""
Write-Host "Register on MDP (create pool first with New-UiTestsManagedDevOpsPool-NedPrd.ps1 if needed):"
...
Write-Host ""
Write-Host "Enable interactive desktop (included in New-UiTestsManagedDevOpsPool-NedPrd.ps1):"
